            ...
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="p-2 cursor-pointer" wire:click="sortBy('kontak')">
                        Kontak @if ($sortField === 'kontak')
                            <span>({{ strtoupper($sortDir) }})</span>
                        @endif
                    </th>
                    <th class="p-2 cursor-pointer" wire:click="sortBy('alamat')">
                        Alamat @if ($sortField === 'alamat')
                            <span>({{ strtoupper($sortDir) }})</span>
                        @endif
                    </th>
            ...
            <tbody>
                @forelse($rows as $r)
                    <tr class="border-b">
                        ...
                        <td class="p-2">
                            <a href="{{ route('master.pemasok.produk', $r->id) }}"
                                class="rounded bg-sky-600 px-3 py-1 text-white hover:bg-sky-700">Produk</a>
